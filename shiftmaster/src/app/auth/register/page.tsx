      ...
      if (currentStep < 3) {
        ...
        try {
          ...
          if (error) {
            ...
            toast.success("登録が完了しました！ログインページへ移動します。");
        ...
        <div className="mb-16">
          <div className="relative max-w-md mx-auto">
            ...
            <div className="absolute top-5 left-5 h-[2px] overflow-hidden" style={{ width: 'calc(100% - 40px)' }}>
              <div 
                className="h-full bg-gradient-to-r from-blue-900 via-blue-700 to-blue-900 transition-all duration-700 ease-out relative"
                style={{ 
                  width: `${progressWidth}%`,
                ...
                <div key={step.number} className="flex flex-col items-center">
                  <div className="relative">
                    ...
                    {currentStep === step.number && (
                      <>
                        <div className="absolute -inset-4 bg-blue-900/10 rounded-full animate-ping" />
                        <div className="absolute -inset-3 bg-blue-900/5 rounded-full animate-pulse" />
                      </>
                    )}
                    ...
                    <div
                      className={`relative w-10 h-10 rounded-full flex items-center justify-center text-xs font-semibold transition-all duration-500 ${
                        currentStep === step.number
                          ? 'bg-gradient-to-br from-blue-900 to-blue-700 text-white shadow-lg scale-125 ring-4 ring-blue-900/20'
                          : currentStep > step.number
                    ...
                    {/* アクティブインジケーター */}
                    {currentStep === step.number && (
                      <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-blue-900 rounded-full animate-bounce" />
                    )}
                  </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 pr-10 border-2 rounded-lg focus:outline-none focus:border-blue-500 transition-colors ${
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6 max-h-64 overflow-y-auto">
                <h3 className="font-semibold text-gray-900 mb-3">ShiftMaster 利用規約</h3>
                <div className="text-sm text-gray-600 space-y-2">
                  <p>第1条（本規約の適用）</p>
                  <p className="pl-4">本規約は、お客様が「ShiftMaster」（以下「本サービス」）をご利用いただく際の条件を定めるものです。</p>
                  <p>第2条（利用登録）</p>
              ...
              <div className="space-y-4">
                <label className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-700">
                    ...
                    および
                    <a href="#" className="text-blue-600 hover:text-blue-700 font-medium underline ml-1">
                      プライバシーポリシー
                    </a>
                ...
                <label className="flex items-start gap-3">
                  ...
                  />
                  <span className="text-sm text-gray-700">
                    ShiftMasterからのお知らせ・キャンペーン情報を受け取る
