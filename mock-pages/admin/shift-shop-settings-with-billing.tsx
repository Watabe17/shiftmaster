...
import {
  ...
  Copy, Sliders, CreditCard, ExternalLink, Receipt, AlertTriangle, Loader2
} from 'lucide-react';

const ShopSettingsWithBilling = () => {
  ...
  const tabs = [
    ...
    { id: 'billing', label: '請求管理', icon: CreditCard }
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 overflow-y-auto bg-gray-50">
        ...
        <div className="p-8">
          ...
          {activeTab === 'billing' && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h2 className="text-lg font-bold text-gray-900 mb-6">請求管理</h2>
              
              <div className="space-y-6">
                {/* 契約情報 */}
                <div>
                  <h3 className="text-sm font-medium text-gray-700 mb-3">契約情報</h3>
                  <dl className="space-y-2 text-sm">
                    <div className="flex items-center justify-between py-2 border-b border-gray-100">
                      <dt className="text-gray-600">プラン</dt>
                      <dd className="font-medium text-gray-900">
                        {billingInfo.planName}
                        <span className="ml-2 px-2 py-0.5 bg-green-100 text-green-700 rounded text-xs">有効</span>
                      </dd>
                    </div>
                    <div className="flex items-center justify-between py-2 border-b border-gray-100">
                      <dt className="text-gray-600">月額料金</dt>
                      <dd className="text-gray-900">¥{billingInfo.price.toLocaleString()}</dd>
                    </div>
                    <div className="flex items-center justify-between py-2 border-b border-gray-100">
                      <dt className="text-gray-600">次回請求日</dt>
                      <dd className="text-gray-900">{billingInfo.nextBillingDate}</dd>
                    </div>
                    <div className="flex items-center justify-between py-2 border-b border-gray-100">
                      <dt className="text-gray-600">支払い方法</dt>
                ...
                <div className="border-t pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <h3 className="text-sm font-medium text-gray-700">請求管理ポータル</h3>
                      <p className="text-xs text-gray-500 mt-1">
                        支払い方法の変更、請求履歴、プラン変更はこちらから
                      </p>
                    </div>
                    <button
                      onClick={() => {
                        ...
                        setTimeout(() => {
                          alert('Stripe Customer Portal を開きます');
...
export default ShopSettingsWithBilling;